...
export default class UserRepository {
  ...
  public async userCreate(userData: CreateUserDto) {
    ...
    // const createUserData: User = await UserEntity.save({ email: userData.email, password: hashedPassword });
    const createUserData = await UserEntity.insert({ email: userData.email, password: hashedPassword });
